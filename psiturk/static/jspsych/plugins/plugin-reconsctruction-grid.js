var ReconstructionGridResponse = (function (jspsych) {
  'use strict';

  const info = {
      name: "reconsctrution-grid",
      parameters: {
   ...
   */
  class ReconstructionGridResponsePlugin {
      constructor(jsPsych) {
  ...
  ReconstructionGridResponsePlugin.info = info;

  return ReconstructionGridResponsePlugin;
